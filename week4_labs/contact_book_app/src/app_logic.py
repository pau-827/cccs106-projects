...
def add_contact(page, inputs, contacts_list_view, db_conn): 
    ...
    # Add to DB (srip whitespace)
    add_contact_db(db_conn, name_input.value.strip(), (phone_input.value or "").strip(), (email_input.value or "").strip())
...
def delete_contact(page, contact_id, db_conn, contacts_list_view): 
    ...
    def confirm_delete(e):
        # Contact will be deleted after user confirms
